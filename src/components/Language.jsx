...
function Language(props){
    ...
    return (
        <div className='flex-none mr-14 relative'>
            <button onClick={toggleMenu} className="px-2 py-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"  className="w-8 h-8 stroke-white hover:stroke-teal-100">
